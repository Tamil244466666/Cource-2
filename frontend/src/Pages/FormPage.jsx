...
import axios from 'axios'
 ...
 const FormPage = ()=>{
    ...
    useEffect(()=>{
        ...
        axios.get('https://cource-project-backend.onrender.com/form/',{cancelToken:source.token}).then((res)=>{
...
const deleteHandler = (value)=>{
    axios.delete(`https://cource-project-backend.onrender.com/form/${value}`).then((res)=>{
        // alert((res.data.status));
    }).catch((err)=>{
        console.log(err);
    })
